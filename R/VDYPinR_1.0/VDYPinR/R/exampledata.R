#' The function is to generate example data for VDYP7inR package
#'
#' @importFrom data.table data.table
#' @return a list contains a polygon file and layer file
#' @export
#' @docType methods
#' @rdname exampledata_VDYP7
#'
#' @author Yong Luo
exampledata_VDYP7 <- function(){
