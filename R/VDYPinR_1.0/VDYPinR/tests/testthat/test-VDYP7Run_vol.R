test_that("VDYP7Run.R: check the volume projection.", {
  library(data.table)
  library(testthat)
  # create 5 polygons
  ...
  testrun1_vol_byspecies <- VDYP7Run(polyFile = polyfile,
                                     layerFile = layerfile,
  ...
  testrun2_vol_byspecies <- VDYP7Run(polyFile = polyfile,
                                     layerFile = layerfile,
                                     utilTable = utilTableGenerator(all = 17.5,
                                                                    askForConfirm = FALSE),
                                     timeSeries = "age",
  ...
  testrun3_vol_byspecies <- VDYP7Run(polyFile = polyfile,
                                     layerFile = layerfile,
                                     utilTable = utilTableGenerator(all = 17.5,
                                                                    askForConfirm = FALSE),
                                     timeSeries = "age",
  ...
  testrun4_vol_byspecies <- VDYP7Run(polyFile = polyfile,
                                     layerFile = layerfile,
                                     utilTable = utilTableGenerator(all = 17.5,
                                                                    askForConfirm = FALSE),
                                     timeSeries = "year",
  ...
  ## test only volume simulation with age with by species
  ## forceRefYear = false
  testrun1_vol_byspecies2 <- VDYP7Run(polyFile = polyfile,
                                      layerFile = layerfile,
                                      utilTable = utilTableGenerator(all = 17.5,
                                                                     askForConfirm = FALSE),
                                      timeSeries = "age",
  ...
  # force current year
  testrun1_vol_byspecies3 <- VDYP7Run(polyFile = polyfile,
                                      layerFile = layerfile,
                                      utilTable = utilTableGenerator(all = 17.5,
                                                                     askForConfirm = FALSE),
                                      timeSeries = "age",
  ...
  # check force year
  testrun1_vol_byspecies4 <- VDYP7Run(polyFile = polyfile,
                                      layerFile = layerfile,
                                      utilTable = utilTableGenerator(all = 17.5,
                                                                     askForConfirm = FALSE),
                                      timeSeries = "age",
  ...
  testrun1_vol_byspecies5 <- VDYP7Run(polyFile = polyfile,
                                      layerFile = layerfile,
                                      utilTable = utilTableGenerator(all = 17.5,
                                                                     askForConfirm = FALSE),
                                      timeSeries = NULL,
  ...
  testrun1_vol_byspecies6 <- VDYP7Run(polyFile = polyfile,
                                      layerFile = layerfile,
                                      utilTable = utilTableGenerator(all = 17.5,
                                                                     askForConfirm = FALSE),
                                      timeSeries = NULL,
  ...
  testrun1_vol_byspecies7 <- VDYP7Run(polyFile = polyfile,
                                      layerFile = layerfile,
                                      utilTable = utilTableGenerator(all = 17.5,
                                                                     askForConfirm = FALSE),
                                      timeSeries = NULL,
  ...
  testrun1_vol_byspecies8 <- VDYP7Run(polyFile = polyfile[FEATURE_ID == 16160455,],
  ...
  testrun1_vol_byspecies9 <- VDYP7Run(polyFile = polyfile[FEATURE_ID == 16160455,],
                                      layerFile = layerfile[FEATURE_ID == 16160455,],
                                      utilTable = utilTableGenerator(all = 17.5,
                                                                     askForConfirm = FALSE),
                                      timeSeries = "age",
