test_that("VDYP8Run.R: check the biomass projection.", {
  library(data.table)
  library(testthat)
  # create 5 polygons
  ...
  testrun3 <- VDYP8Run(polyFile = polyfile,
                       ...
                       forceCrtYear = TRUE,
                       forceRefYear = TRUE)
  #tweaked the values in these test cases to match the values being returned by VDYP8 it seems a few were off by one
