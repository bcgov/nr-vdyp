...
DROP TABLE IF EXISTS "app-vdyp"."projection_status_code" CASCADE
;

/* Create Tables */

CREATE TABLE "app-vdyp"."projection_status_code"
(
...
ALTER TABLE "app-vdyp"."projection_status_code" ADD CONSTRAINT "prjstat_pk"
	PRIMARY KEY ("projection_status_code")
;

/* Create Table Comments, Sequences for Autonumber Columns */

COMMENT ON TABLE "app-vdyp"."projection_status_code"
	IS 'Projection Status Code is the current status of the projection. Values are: - Draft - Queued - Started - Completed - Canceled'
;

COMMENT ON COLUMN "app-vdyp"."projection_status_code"."projection_status_code"
...
COMMENT ON COLUMN "app-vdyp"."projection_status_code"."description"
	IS 'DESCRIPTION is the display quality description of the code value.'
;

COMMENT ON COLUMN "app-vdyp"."projection_status_code"."display_order"
	IS 'DISPLAY ORDER is to allow non alphabetic sorting e.g. M T W Th F S S.'
;

COMMENT ON COLUMN "app-vdyp"."projection_status_code"."effective_date"
	IS 'EFFECTIVE_DATE is the date code value becomes effective.'
;

COMMENT ON COLUMN "app-vdyp"."projection_status_code"."expiry_date"
	IS 'EXPIRY_DATE is the date code value expires.'
;

COMMENT ON COLUMN "app-vdyp"."projection_status_code"."revision_count"
...
COMMENT ON COLUMN "app-vdyp"."projection_status_code"."create_user"
	IS 'CREATE_USER is an audit column that indicates the user that created the record.'
;

COMMENT ON COLUMN "app-vdyp"."projection_status_code"."create_date"
	IS 'CREATE_DATE is the date and time the row of data was created.'
;

COMMENT ON COLUMN "app-vdyp"."projection_status_code"."update_user"
	IS 'UPDATE_USER is an audit column that indicates the user that updated the record.'
;

COMMENT ON COLUMN "app-vdyp"."projection_status_code"."update_date"
