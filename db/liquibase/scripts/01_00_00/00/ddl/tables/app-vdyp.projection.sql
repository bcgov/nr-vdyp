...
(
	...
	"projection_parameters_json" varchar(2000) NOT NULL,    -- Projection Parameters JSON is a JSON encoded string containing all parameters required to run this projection
...
ALTER TABLE "app-vdyp"."projection" ADD CONSTRAINT "prjctn_uk" UNIQUE ("layer_projection_file_set_guid","polygon_projection_file_set_guid","vdyp_user_guid","result_projection_file_set_guid")
;
...
ALTER TABLE "app-vdyp"."projection" ADD CONSTRAINT "prjctn_fileset_layer_fk"
	FOREIGN KEY ("layer_projection_file_set_guid") REFERENCES "app-vdyp"."projection_file_set" ("projection_file_set_guid") ON DELETE No Action ON UPDATE No Action
;

ALTER TABLE "app-vdyp"."projection" ADD CONSTRAINT "prjctn_fileset_polygon_fk"
	FOREIGN KEY ("polygon_projection_file_set_guid") REFERENCES "app-vdyp"."projection_file_set" ("projection_file_set_guid") ON DELETE No Action ON UPDATE No Action
;
...
ALTER TABLE "app-vdyp"."projection" ADD CONSTRAINT "prjctn_fileset_result_fk"
	FOREIGN KEY ("result_projection_file_set_guid") REFERENCES "app-vdyp"."projection_file_set" ("projection_file_set_guid") ON DELETE No Action ON UPDATE No Action
;
