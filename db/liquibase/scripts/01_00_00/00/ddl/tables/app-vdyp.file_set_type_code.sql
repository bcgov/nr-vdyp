...
DROP TABLE IF EXISTS "app-vdyp"."file_set_type_code" CASCADE
;

/* Create Tables */

CREATE TABLE "app-vdyp"."file_set_type_code"
(
...
COMMENT ON COLUMN "app-vdyp"."file_set_type_code"."create_user"
	IS 'CREATE_USER is an audit column that indicates the user that created the record.'
;

COMMENT ON COLUMN "app-vdyp"."file_set_type_code"."create_date"
	IS 'CREATE_DATE is the date and time the row of data was created.'
;

COMMENT ON COLUMN "app-vdyp"."file_set_type_code"."update_user"
	IS 'UPDATE_USER is an audit column that indicates the user that updated the record.'
;

COMMENT ON COLUMN "app-vdyp"."file_set_type_code"."update_date"
