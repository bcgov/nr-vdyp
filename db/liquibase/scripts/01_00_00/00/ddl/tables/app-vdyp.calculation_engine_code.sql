...
DROP TABLE IF EXISTS "app-vdyp"."calculation_engine_code" CASCADE
;

/* Create Tables */

CREATE TABLE "app-vdyp"."calculation_engine_code"
(
...
ALTER TABLE "app-vdyp"."calculation_engine_code" ADD CONSTRAINT "calc_eng_pk"
	PRIMARY KEY ("calculation_engine_code")
;

/* Create Table Comments, Sequences for Autonumber Columns */

COMMENT ON TABLE "app-vdyp"."calculation_engine_code"
	IS 'Calculation Engine Code is a future proofing aggregation of versions of individual internal components Values are: - 8.0 '
;

COMMENT ON COLUMN "app-vdyp"."calculation_engine_code"."calculation_engine_code"
...
COMMENT ON COLUMN "app-vdyp"."calculation_engine_code"."description"
	IS 'DESCRIPTION is the display quality description of the code value.'
;

COMMENT ON COLUMN "app-vdyp"."calculation_engine_code"."display_order"
	IS 'DISPLAY ORDER is to allow non alphabetic sorting e.g. M T W Th F S S.'
;

COMMENT ON COLUMN "app-vdyp"."calculation_engine_code"."effective_date"
	IS 'EFFECTIVE_DATE is the date code value becomes effective.'
;

COMMENT ON COLUMN "app-vdyp"."calculation_engine_code"."expiry_date"
	IS 'EXPIRY_DATE is the date code value expires.'
;

COMMENT ON COLUMN "app-vdyp"."calculation_engine_code"."revision_count"
...
COMMENT ON COLUMN "app-vdyp"."calculation_engine_code"."create_user"
	IS 'CREATE_USER is an audit column that indicates the user that created the record.'
;

COMMENT ON COLUMN "app-vdyp"."calculation_engine_code"."create_date"
	IS 'CREATE_DATE is the date and time the row of data was created.'
;

COMMENT ON COLUMN "app-vdyp"."calculation_engine_code"."update_user"
	IS 'UPDATE_USER is an audit column that indicates the user that updated the record.'
;

COMMENT ON COLUMN "app-vdyp"."calculation_engine_code"."update_date"
