...
CREATE TABLE "batch"."batch_job_claim" (
    ...
    lease_token_guid UUID NOT NULL,       -- Lease Token GUID is a randomly generated UUID known by the owner to secure updates
...
COMMENT
ON COLUMN "batch"."batch_job_claim"."lease_token_guid"
