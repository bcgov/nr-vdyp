...
class CloseUtilVolumeParserTest {
	...
	@ParameterizedTest
	@MethodSource("inputStreamGenerator")
	void testParseTwoClassesWithBlankKey(InputStream is) throws Exception {
	...
	private static Stream<InputStream> inputStreamGenerator() {
		   return Stream.of(
