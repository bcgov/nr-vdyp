...
export const getStatusIcon = (status: string): string => {
  const iconMap: Record<string, string> = {
    ...
    Stuck: new URL('@/assets/icons/Stuck_Icon_26px.svg', import.meta.url).href,
    Queued: new URL('@/assets/icons/Queued_icon_26px.svg', import.meta.url).href,
    Failed: new URL('@/assets/icons/Failed_Icon_Status.png', import.meta.url).href,
    'Cancelled By Administrator': new URL('@/assets/icons/Canceled_by_admin_26px.png', import.meta.url).href,
  }
