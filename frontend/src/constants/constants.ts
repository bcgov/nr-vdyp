export const KEYCLOAK = Object.freeze({
  ...
  IDP_AZUR_BBCEID: 'bceidbusiness',
  IDP_AZUR_BCSC: 'vdyp-service-6216',
...
export const NUM_INPUT_LIMITS = Object.freeze({
  ...
  PERCENT_STOCKABLE_AREA_DECIMAL_NUM: 0,
  CROWN_CLOSURE_MAX: 100,
  CROWN_CLOSURE_MIN: 0,
  CROWN_CLOSURE_STEP: 5,
  CROWN_CLOSURE_DECIMAL_NUM: 0,
  TPH_MAX: 9999.9,
  TPH_MIN: 0.1,
  TPH_STEP: 250,
  TPH_DECIMAL_NUM: 2,
  ...
  STARTING_AGE_DECIMAL_NUM: 0,
  FINISHING_AGE_MAX: 2000,
  FINISHING_AGE_MIN: 1,
  FINISHING_AGE_STEP: 10,
  FINISHING_AGE_DECIMAL_NUM: 0,
  AGE_INC_MAX: 350,
  AGE_INC_MIN: 1,
  AGE_INC_STEP: 5,
  AGE_INC_DECIMAL_NUM: 0,
  START_YEAR_MIN: 1400,
  START_YEAR_MAX: 2500,
  START_YEAR_STEP: 1,
  START_YEAR_DECIMAL_NUM: 0,
  END_YEAR_MIN: 1400,
  END_YEAR_MAX: 2500,
  END_YEAR_STEP: 1,
  END_YEAR_DECIMAL_NUM: 0,
  YEAR_INC_MIN: 1,
  YEAR_INC_MAX: 350,
  YEAR_INC_STEP: 1,
  YEAR_INC_DECIMAL_NUM: 0,
  SPECIFIC_YEAR_MIN: 1400,
  SPECIFIC_YEAR_MAX: 2500,
  SPECIFIC_YEAR_STEP: 1,
  SPECIFIC_YEAR_DECIMAL_NUM: 0,
})
