...
export const Default: Story = {
  render: () => ({
    ...
    setup() {
      ...
      fileUploadStore.panelOpenStates.reportInfo = CONSTANTS.PANEL.OPEN
      fileUploadStore.panelState.reportInfo.confirmed = false
      fileUploadStore.panelState.reportInfo.editable = true
...
export const Confirmed: Story = {
  render: () => ({
    ...
    setup() {
      ...
      appStore.setViewMode('create')
      fileUploadStore.panelOpenStates.reportInfo = CONSTANTS.PANEL.OPEN
      fileUploadStore.panelState.reportInfo.confirmed = true
      fileUploadStore.panelState.reportInfo.editable = false
      fileUploadStore.reportTitle = 'Sample Forest Projection 2024'
      fileUploadStore.projectionType = CONSTANTS.PROJECTION_TYPE.VOLUME
...
export const PanelCollapsed: Story = {
  render: () => ({
    ...
    setup() {
      ...
      appStore.setViewMode('create')
      fileUploadStore.panelOpenStates.reportInfo = CONSTANTS.PANEL.CLOSE
      fileUploadStore.panelState.reportInfo.confirmed = false
      fileUploadStore.panelState.reportInfo.editable = true
    },
    template: '<ReportConfigPanel />',
