...
public class BatchException extends RuntimeException {
	...
	public static BatchException handleException(
			Object context, Exception cause, String errorDescription, Logger logger) {
	...
	public static BatchException handleBatchProcessingFailure(
			Long jobExecutionId, Exception cause, String errorDescription, Logger logger) {
