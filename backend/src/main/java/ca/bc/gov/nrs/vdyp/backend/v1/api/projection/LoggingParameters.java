...
public class LoggingParameters {
	...
	private LoggingParameters(Parameters params) {
		...
		if (params == null) {
			params = new Parameters().selectedExecutionOptionsText(new ArrayList<String>())
					.selectedDebugOptionsText(new ArrayList<String>());
		}

		if (params.getSelectedExecutionOptionsText()
		...
		if (params.getSelectedDebugOptionsText()
