...
public enum SpecialLayerTypeCode {
	PRIMARY("P", ProjectionTypeCode.PRIMARY), VETERAN("V", ProjectionTypeCode.VETERAN),
	REGEN("Y", ProjectionTypeCode.REGENERATION), RESIDUAL("R", ProjectionTypeCode.RESIDUAL),
	DEAD("D", ProjectionTypeCode.DEAD);

	public final String code;
	public final ProjectionTypeCode projectionType;

	SpecialLayerTypeCode(String code, ProjectionTypeCode projectionType) {
		this.code = code;
	 ...
	 * @see ProjectionType
	 */
	public SpecialLayerTypeCode fromProjectionType(ProjectionTypeCode projectionType) {

		for (var e : SpecialLayerTypeCode.values()) {
	...
	public static boolean doesLayerIdIdentifyASpecialLayerType(String candidate) {
		for (SpecialLayerTypeCode e : SpecialLayerTypeCode.values()) {
