...
public class UnsupportedYieldTableRecordBean implements YieldTableRowBean {

	@SuppressWarnings("unused")
	private static final Logger logger = LoggerFactory.getLogger(UnsupportedYieldTableRecordBean.class);

	public UnsupportedYieldTableRecordBean() {
