...
import static ca.bc.gov.nrs.vdyp.backend.v1.gen.model.Parameters.SelectedExecutionOptionsEnum.DO_ALLOW_BASAL_AREA_AND_TREES_PER_HECTARE_VALUE_SUBSTITUTION;
import static ca.bc.gov.nrs.vdyp.backend.v1.gen.model.Parameters.SelectedExecutionOptionsEnum.DO_INCLUDE_AGE_ROWS_IN_YIELD_TABLE;
import static ca.bc.gov.nrs.vdyp.backend.v1.gen.model.Parameters.SelectedExecutionOptionsEnum.DO_INCLUDE_COLUMN_HEADERS_IN_YIELD_TABLE;
import static ca.bc.gov.nrs.vdyp.backend.v1.gen.model.Parameters.SelectedExecutionOptionsEnum.DO_INCLUDE_FILE_HEADER;
import static ca.bc.gov.nrs.vdyp.backend.v1.gen.model.Parameters.SelectedExecutionOptionsEnum.DO_INCLUDE_PROJECTED_MOF_VOLUMES;
import static ca.bc.gov.nrs.vdyp.backend.v1.gen.model.Parameters.SelectedExecutionOptionsEnum.DO_INCLUDE_PROJECTION_MODE_IN_YIELD_TABLE;
import static ca.bc.gov.nrs.vdyp.backend.v1.gen.model.Parameters.SelectedExecutionOptionsEnum.DO_INCLUDE_YEAR_ROWS_IN_YIELD_TABLE;
import static ca.bc.gov.nrs.vdyp.backend.v1.gen.model.Parameters.SelectedExecutionOptionsEnum.DO_SUMMARIZE_PROJECTION_BY_LAYER;
import static ca.bc.gov.nrs.vdyp.backend.v1.gen.model.Parameters.SelectedExecutionOptionsEnum.FORWARD_GROW_ENABLED;
...
/**
 * This class represents a Parameters instance that has been validated. It provides accessors to get the various
 * Parameters fields that are not Strings internally in those formats.
 */
@RegisterForReflection
public class ValidatedParameters extends Parameters {
	...
	@Transient
	/** This parameter is not exposed to the client. It is fixed. */
	...
	@Transient
	private List<UtilizationParameterText> utils = new ArrayList<>();
	...
	public ValidatedParameters utils(List<UtilizationParameterText> utils) {
		this.utils = utils;
		return this;
	}

	public ValidatedParameters addUtilsItem(UtilizationParameterText utilsItem) {
		if (this.utils == null) {
	 ...
	 * @return utils
	 */
	public List<UtilizationParameterText> getUtils() {
		return Collections.unmodifiableList(utils);
	}

	public void setUtils(List<UtilizationParameterText> utils) {
		this.utils = utils;
	}
