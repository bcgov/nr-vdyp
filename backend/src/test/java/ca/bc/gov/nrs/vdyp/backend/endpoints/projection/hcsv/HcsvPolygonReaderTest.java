package ca.bc.gov.nrs.vdyp.backend.endpoints.projection.hcsv;
...
public class HcsvPolygonReaderTest {
	...
	void testHscvPolygonReader() throws IOException {
		...
		Path resourceFolderPath = Path.of(FileHelper.TEST_DATA_FILES, FileHelper.HCSV, FileHelper.COMMON);
