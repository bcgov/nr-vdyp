...
class Hcsv_Vdyp7_Comparison_Test {
	...
	@Test
	void testBranchBiomassEdgeCases() throws IOException, ResourceParseException, CsvException {
		logger.info("Starting vdyp-1172");
		// Ignore volume details some biomass projections seemed to include them, these did not in VDYP7 but do in 8
		Pattern ignorePattern = Pattern.compile(
				"PRJ_LOREY_HT|PRJ_PCNT_STOCK|PRJ_SITE_INDEX|PRJ_DOM_HT|PRJ_DIAMETER|PRJ_TPH|PRJ_BA|PRJ_SCND_HT"
		);

		try (InputStream vdyp7Stream = MainTest.class.getResourceAsStream("vdyp-1172/output/VDYP7YieldTable.csv")) {
			String vdyp7YieldTableContent = new String(vdyp7Stream.readAllBytes());
			runIntTestData("vdyp-1172", result -> {
				var vdyp7YieldTable = new ResultYieldTable(vdyp7YieldTableContent);
				ResultYieldTable.compareWithTolerance(vdyp7YieldTable, result, 0.01, ignorePattern.asMatchPredicate());
			});
		}
	...
	@Test
	void testFoilageBiomassEdgeCases() throws IOException, ResourceParseException, CsvException {
		logger.info("Starting vdyp-1173");
		// Ignore volume details some biomass projections seemed to include them, these did not in VDYP7 but do in 8
		Pattern ignorePattern = Pattern.compile(
				"PRJ_LOREY_HT|PRJ_PCNT_STOCK|PRJ_SITE_INDEX|PRJ_DOM_HT|PRJ_DIAMETER|PRJ_TPH|PRJ_BA|PRJ_SCND_HT"
		);

		try (InputStream vdyp7Stream = MainTest.class.getResourceAsStream("vdyp-1173/output/VDYP7YieldTable.csv")) {
			String vdyp7YieldTableContent = new String(vdyp7Stream.readAllBytes());
			runIntTestData("vdyp-1173", result -> {
				var vdyp7YieldTable = new ResultYieldTable(vdyp7YieldTableContent);
				ResultYieldTable.compareWithTolerance(vdyp7YieldTable, result, 0.01, ignorePattern.asMatchPredicate());
			});
		}
	...
	void test1175() throws IOException, ResourceParseException, URISyntaxException, CsvException {
		...
		Pattern ignorePattern = Pattern.compile("");
		try (InputStream vdyp7Stream = MainTest.class.getResourceAsStream("vdyp-1175/output/VDYP7YieldTable.csv")) {
			String vdyp7YieldTableContent = new String(vdyp7Stream.readAllBytes());
			runIntTestData("vdyp-1175", result -> {
				var vdyp7YieldTable = new ResultYieldTable(vdyp7YieldTableContent);
				ResultYieldTable.compareWithTolerance(vdyp7YieldTable, result, 0.01, ignorePattern.asMatchPredicate());
			});
		}
	...
	@Test
	void test1177() throws IOException, ResourceParseException, CsvException {
		logger.info("Starting vdyp-1177");
		// Ignore site index, something about polygon
		Pattern ignorePattern = Pattern.compile("");
		try (InputStream vdyp7Stream = MainTest.class.getResourceAsStream("vdyp-1177/output/VDYP7YieldTable.csv")) {
			String vdyp7YieldTableContent = new String(vdyp7Stream.readAllBytes());
			runIntTestData("vdyp-1177", result -> {
				var vdyp7YieldTable = new ResultYieldTable(vdyp7YieldTableContent);
				ResultYieldTable.compareWithTolerance(vdyp7YieldTable, result, 0.01, ignorePattern.asMatchPredicate());
			});
		}
	...
	void test1180() throws IOException, ResourceParseException, URISyntaxException, CsvException {
		...
		try (InputStream vdyp7Stream = MainTest.class.getResourceAsStream("vdyp-1180/output/VDYP7YieldTable.csv")) {
			String vdyp7YieldTableContent = new String(vdyp7Stream.readAllBytes());
			runIntTestData("vdyp-1180", result -> {
				var vdyp7YieldTable = new ResultYieldTable(vdyp7YieldTableContent);
				ResultYieldTable.compareWithTolerance(vdyp7YieldTable, result, 0.01, ignorePattern.asMatchPredicate());
			});
		}
	...
	void testStockabilityEdgeCases() throws IOException, ResourceParseException, URISyntaxException, CsvException {
		...
		// there are other tickets hat will likely fix these edge cases
		Pattern ignorePattern = Pattern.compile("");
		try (InputStream vdyp7Stream = MainTest.class.getResourceAsStream("vdyp-1178/output/VDYP7YieldTable.csv")) {
			String vdyp7YieldTableContent = new String(vdyp7Stream.readAllBytes());
			runIntTestData("vdyp-1178", result -> {
				var vdyp7YieldTable = new ResultYieldTable(vdyp7YieldTableContent);
				ResultYieldTable.compareWithTolerance(vdyp7YieldTable, result, 0.01, ignorePattern.asMatchPredicate());
			});
		}
	...
	@Test
	void testDuplicateSpecies() throws IOException, ResourceParseException, URISyntaxException, CsvException {
		logger.info("Starting vdyp-598");
		// Two of these polygons do not have enough information to produce a proper projection for the primary species,
		// VDYP-1176 is a fix for dominant height looing into the other values that do not match would be scope creep
		// there are other tickets hat will likely fix these edge cases
		Pattern ignorePattern = Pattern.compile("");
		try (InputStream vdyp7Stream = MainTest.class.getResourceAsStream("vdyp-598/output/VDYP7YieldTable.csv")) {
			String vdyp7YieldTableContent = new String(vdyp7Stream.readAllBytes());
			runIntTestData("vdyp-598", result -> {
				var vdyp7YieldTable = new ResultYieldTable(vdyp7YieldTableContent);
				ResultYieldTable.compareWithTolerance(vdyp7YieldTable, result, 0.01, ignorePattern.asMatchPredicate());
			});
		}
	...
	void testDuplicateInYieldTableiNSuppliedOrder() throws IOException, ResourceParseException {
		...
		Pattern ignorePattern = Pattern.compile("TABLE_NUM");
		try (InputStream vdyp7Stream = MainTest.class.getResourceAsStream("vdyp-1026a/output/VDYP7YieldTable.csv")) {
			String vdyp7YieldTableContent = new String(vdyp7Stream.readAllBytes());
			runIntTestData("vdyp-1026a", result -> {
				var vdyp7YieldTable = new ResultYieldTable(vdyp7YieldTableContent);
				ResultYieldTable.compareWithTolerance(vdyp7YieldTable, result, 0.01, ignorePattern.asMatchPredicate());
			});
		}
