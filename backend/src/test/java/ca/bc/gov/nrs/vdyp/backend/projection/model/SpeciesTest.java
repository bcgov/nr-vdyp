    ...
    class UndefinedValueCalculations {
        ...
        void testInsufficientData(){
            var unit = baseConfig(new Species.Builder())
                    .siteIndex(Vdyp7Constants.EMPTY_DECIMAL)
                    .dominantHeight(Vdyp7Constants.EMPTY_DECIMAL)
                    .totalAge(Vdyp7Constants.EMPTY_DECIMAL)
                    .yearsToBreastHeight(Vdyp7Constants.EMPTY_DECIMAL)
                    .build();
        ...
        void testMinimalTotalAgeCalculation(){
            var unit = baseConfig(new Species.Builder())
                    .ageAtBreastHeight(42.0)
                    .yearsToBreastHeight(42.0)
                    .build();
        ...
        static Stream<Arguments> FIPStartNonProductiveParams(){
            return Stream.of(
                    Arguments.of(0.6, 0.5, "NP", 0.1),
                    Arguments.of(0.5, 0.5, "AF", 0.1),
                    Arguments.of(0.5, 0.5, "UNK", 0.5),
                    Arguments.of(1.6, 0.5, "UNK", 0.5),
                    Arguments.of(1.6, 0.5, "AF", 0.5)
            );
        }
        @ParameterizedTest
        @MethodSource("FIPStartNonProductiveParams")
        void testFIPStartNonProductive(double totalAge, double yearsToBreastHeight, String nonProductiveDescriptor, double expectedValue)
        {
            // Create new base definitions so the polygon in this case is FIP nonproductive
            var polygon = new Polygon.Builder()
                    .inventoryStandard(InventoryStandard.FIP)
                    .nonProductiveDescriptor(nonProductiveDescriptor)
                    .build();
            var layer = new Layer.Builder()
                    .polygon(polygon)
                    .layerId("Test")
            ...
            var unit = baseConfig(new Species.Builder())
                    .stand(stand)
                    .totalAge(totalAge)
                    .yearsToBreastHeight(yearsToBreastHeight)
                    .build();
        ...
        void testDetermineAgeFromDominantHeightAndSiteIndex(Double yearsToBreastHeight,
                                                            Double dominantHeight,
                                                            Double siteIndex,
                                                            SiteIndexEquation siteCurve,
                                                            Double expected) {
            var unit = baseConfig(new Species.Builder())
                    .totalAge(null)
                    .yearsToBreastHeight(yearsToBreastHeight)
        ...
        void testDetermineDominantHeightFromAgeAndSiteIndex(Double yearsToBreastHeight,
                                                            Double age,
                                                            Double siteIndex,
                                                            SiteIndexEquation siteCurve,
                                                            Double expected) {
        ...
        @ParameterizedTest
        @MethodSource("dominantHeightFromAgeAndSiteIndex")
        void testDirectDetermineDominantHeightFromAgeAndSiteIndex(Double yearsToBreastHeight,
                                                            Double age,
                                                            Double siteIndex,
                                                            SiteIndexEquation siteCurve,
                                                            Double expected) {
        ...
        void testAddDuplicate()
        {
            ...
            var unit = new Species.Builder()
                    .stand(stand)
                    .speciesCode("PL")
                    .speciesPercent(25)
                    .build();
            var collaborator = new Species.Builder()
                    .stand(stand)
                    .speciesCode("PL")
                    .speciesPercent(25)
                    .totalAge(42.0)
