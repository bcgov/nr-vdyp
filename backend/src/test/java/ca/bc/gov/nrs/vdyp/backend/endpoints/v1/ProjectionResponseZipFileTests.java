...
class ProjectionResponseZipFileTests {
	...
	@Test
	void singlePolygonTestAll() throws IOException {

		logger.info("Starting singlePolygonTestAll");
...
//		String serializedParametersText = mapper.writeValueAsString(parameters);
		...
		assertTrue(entry3Content.contains("\"Polygon Number\" value \"000A0005626138\" is not a number"));
	...
	@Test
	void singlePolygonTestNone() throws IOException {

		logger.info("Starting singlePolygonTestNone");
