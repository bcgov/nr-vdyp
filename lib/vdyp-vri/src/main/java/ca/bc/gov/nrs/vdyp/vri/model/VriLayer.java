...
public class VriLayer extends BaseVdypLayer<VriSpecies, VriSite> implements InputLayer {
	...
	public static class Builder
		...
		protected VriLayer doBuild() {
			// We want the reciprocal of the forest fraction. When we output at the other end the derived values are
			// multiplied by the forest fraction canceling this out.
