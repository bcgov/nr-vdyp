...
public class ProcessingTestUtils {
	...
	public static float sumUtilizationClassValues(UtilizationVector ucValues, List<UtilizationClass> subjects) {
		float sum = 0.0f;
	...
	public static float sumSpeciesUtilizationClassValues(VdypLayer layer, String uvName, UtilizationClass uc) {
		float sum = 0.0f;
