 ...
 */
public class BaseDebugSettings implements DebugSettings {

	private static final Logger logger = LoggerFactory.getLogger(BaseDebugSettings.class);
	 ...
	 * ignored.
	 */
	public BaseDebugSettings(Integer[] settings) {
