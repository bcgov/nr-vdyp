...
/**
 * The LessThan13Exception exist to replace the SI_ERR_LT13(-1) error code found in the orginal C code
 * This exception is generally thrown when there a site index is less than or equal to 1.3
 */
