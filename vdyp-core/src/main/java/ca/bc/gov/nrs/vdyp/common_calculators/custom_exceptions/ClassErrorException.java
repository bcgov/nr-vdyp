...
/**
 * The ClassErrorException exist to replace the SI_ERR_CLASS(-6) error code found in the orginal C code
 * This exception is generally thrown when the site class is unknown, not valid or a similar issue
 */
