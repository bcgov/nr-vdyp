...
/**
 * The SpeciesErrorException exist to replace the SI_ERR_SPEC(-10) error code found in the orginal C code
 * This exception is generally thrown when if the input parameter is not a valid species index or
 * there is another species related error
 */
